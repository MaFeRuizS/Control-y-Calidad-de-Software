...
public class GameManager : MonoBehaviour
{
    ...
    public void TerminarJuego(bool victoria) {
        ...
        // Detenemos el generador de ciencias y destruimos lo que esté cayendo
        ...
        if (victoria) {
            ...
            // Usamos los textos de Game Over
